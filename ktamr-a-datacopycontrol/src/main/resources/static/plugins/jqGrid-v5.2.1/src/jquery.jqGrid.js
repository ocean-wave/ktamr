...
//module begin
        ...
        return this.each(function () {
                    ...
                    if (pgboxes) {
                        ...
                        if (ts.p.viewrecords) {
                            if (ts.p.reccount === 0) {
                                ...
                                //其中from代表当前页，to代表有多少页，tot代表总记录数
                                if (tot > 10000) {
                                    tot = toThousands(tot);
                                    tot = '大于10000';
                                }
			...
			*/
                ...
                buildSearchBox = function (index, top, left, parent) {
                    var cm = ts.p.colModel[index], rules, o1 = '', v1 = '', r1 = '', o2 = '', v2 = '', so, op,
                        repstr = '', selected, elem,
                ...
                buildColMenu = function (index, left, top) {
                    ...
                    var str = '<ul id="column_menu" class="ui-search-menu modal-content column-menu" role="menu" tabindex="0" style="font-size:' + fs + ';left:' + left + 'px;top:' + top + 'px;">',
                        cm = ts.p.colModel[index], op = $.extend({
                            sorting: true,
                            columns: true,
                            filtering: true,
                            seraching: true,
            ...
            $("th", thr).each(function (j) {
                ...
                if (ts.p.footerrow) {
                    if (j == 1) {
                        tfoot += "<td role='gridcell' colspan='3' title='总计:'>总计:</td>";
                    }
                    else if (j == 2 || j == 3 || j == 4 || j == 5) {
                        tfoot += " <td role='gridcell' style='display: none;'></td> ";
                    }
                    else {
    ...
    $.jgrid.extend({
        ...
        addRowData: function (rowid, rdata, pos, src) {
            ...
            var success = false, nm, row, rnc = "", msc = "", gi, si, ni, sind, i, v, prp = "", aradd, cnm, data, cm,
                id;
            if (rdata) {
                if ($.isArray(rdata)) {
                    aradd = true;
                ...
                this.each(function () {
                    ...
                    var k = 0,
                        classes = $(t).jqGrid('getStyleUI', t.p.styleUI + ".base", 'rowBox', true, 'jqgrow ui-row-' + t.p.direction),
                        lcdata = {},
        ...
        setGridWidth: function (nwidth, shrink) {
            return this.each(function () {
                ...
                var $t = this, cw,
                    ...
                    scw = $t.p.scrollOffset, aw, gw = 0, cr, bstw = $t.p.styleUI === 'Bootstrap' ? 2 : 0;
    ...
    $.jgrid.extend({
        ...
        filterInput: function (val, p) {
            ...
            return this.each(function () {
                ...
                if (!bsr) {
                    $($t).jqGrid("setGridParam", {search: true}).trigger("reloadGrid", [{page: 1}]);
                }
...
// requiere load multiselect before grid
    ...
    $.jgrid.extend({
        ...
        columnChooser: function (opts) {
            var self = this, selector, select, colMap = {}, fixedCols = [], dopts, mopts, $dialogContent,
                multiselectData, listHeight,
