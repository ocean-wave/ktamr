...
public interface HatMetersReplaceMapper  {

    List<HatMetersreplace> HatMetersReplaceList(HatMetersreplace hatMetersreplace);

    //将excel文档中的数据导入到零时表中
    Integer addHatMetersReplace(@Param("params") List<Map<String, Object>> params);
...
//    ---------------------------------------
    ...
    //插入一条批量换表命令
    Integer addBatchChangeMeter(@Param("fileName") String fileName,@Param("operatorCode") String operatorCode,@Param("msg") String msg);
